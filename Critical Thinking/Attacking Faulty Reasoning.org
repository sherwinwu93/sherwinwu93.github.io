...
定义: 试图去拥护某个立场通过模糊的表达的方法, 或者是得到无正当理由的结论通过把别人模糊的表达加上了精确的意义.
wusd:
...
Equivocation 2 9
Ambiguity 14 7
Misleading Accent 10 3
Illicit Contrast 5 12
Argument by Innuendo 8 1
Misue of a Vague Expression 13 6
Distinction Without a Difference 4 11
1. 
		你老公和新来的助理有一腿. IC
		你老公最近工作晚. P
		新来的助理也晚. P
...
定义: 假设: 1. 在事物和其反面,做一点连续的不同,影响微不足道; 2. 在同一条线上的两个点,做不了区分,或者区分是很武断的.
...
*** Misuse of principle
定义: 通过假定规则没有例外错误地使用规则.相反地,尝试去反驳某个规则通过例外的情况.
