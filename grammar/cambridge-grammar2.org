...
** 动词的-ing形式与不定式比较 54 55-63 65 66
...
-ing分句:
	...
	- 一动作发生在一动作之前(太短暂不用),在前的动作用having done 或 after ing
...
- where指代从句的地点=从句的there
	注意先行词是地点,而是地点状语,且介词不要了!!!. a place(先行词) where
