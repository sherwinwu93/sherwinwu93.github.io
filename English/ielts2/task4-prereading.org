...
2. 认真阅读听⼒脚本，标注所有⽣词（⽂中含义），语法（参考新
概念英语及三本语法书），摘抄习惯⽤法（并造句）
3. 反复跟读edge或听⼒⾳频，⽆需熟读成诵，但请跟读到⾜够顺
畅。拿不准就跟读50遍。
1. 模拟考试，听⽂章，答题，记录对错。
2. 对⽐1&4 答题情况
3. 做完前5步，请思考并写下，【阅读与听⼒】的关系。
** questions
** first
1. egg
	 t
...
- He designed a beautiful cover that goes round strawberries at a time when these were very popular.
