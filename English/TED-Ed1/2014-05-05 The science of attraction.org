...
cologne: 科隆香水
pheromones: 信息素
physiologyical: the science that studies the way in which the bodies of living things work生理学的
...
molecule: the smallest unit into which any substance can be divided without losing its own chemical nature, usually consisting of two or more atoms分子
breathy: 缺少声量的
