...
interchangeable/interchangeably: things that are interchangeable can be used instead of each other可互换的
conference: a large formal meeting where a lot of people discuss important matters such as business, politics, or science, especially for several days协商会
skyscraper: a very tall modern city building摩天楼
know-how: knowledge, practical ability, or skill to do something实际知识
...
mirror: if one thing mirrors another, it is very similar to it and may seem to copy or represent it SYN reflect反映
arrangement: 排列, 安排
...
reflect: to show or be a sign of a particular situation or feeling反射
boundary: the real or imaginary line that marks the edge of a state, country etc, or the edge of an area of land that belongs to someone边界
ethnicity: 种族划分
----------------------------------------
