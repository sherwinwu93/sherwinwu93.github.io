...
** expression
fossil: 化石
tour: to visit several parts of a country or area旅游
...
exclusive: available or belonging only to particular people, and not shared独占的
fossilization: 化石作用
...
harden: to become firm or stiff, or to make something firm or stiff OPP soften变硬
...
shallow: measuring only a short distance from the top to the bottom OPP deep浅的
muddy: covered with mud or containing mud泥泞的
...
erosion: the process by which rock or soil is gradually destroyed by wind, rain, or the sea腐蚀
intrepid: willing to do dangerous things or go to dangerous places – often used humorously SYN brave无畏的
...
magnificent: very good or beautiful, and very impressive华丽的
shed: GET RID OF to get rid of something that you no longer need or want摆脱
disintegrate: to ak up, or make something ak up, into very small pieces(使)分解
