...
Even in the 21st century,
	only a few people in surgery teams have actually seen a working heart.
Internet searches for heart function, point to crude models, diagrams or animations
	that don't really show how it works.
It's as if there has been a centuries old conspiracy amongst teachers and students to accept
	that heart function cannot be demonstrated. 
...
That way students might not fully grasp the way it works, but can superficially understand it,
		learning such concepts
			as the heart is a four-chambered organ,
...
Blood goes from one heart pump to the lungs, back to the second heart pump,
	which sends it to the body, and then back to the first pump.
