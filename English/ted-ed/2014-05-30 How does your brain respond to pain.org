...
personalized: 
----------------------------------------
received constant electric shocks to your hands: 
distract you from the task: 
do sth. faster and better when +... than when +...: 
send their mind wandering: 
be subjected to the: 
describe it on a scale from zero, no pain, to ten: 
fire and send signals to: 
responds to sth.: 
cope with these: 
take your hand off sth.: 
the runner's high: 
act on cells: 
