...
there's at least one way to arrange: 
maximize/minimize the attraction/repulsion of: 
A. matter to B.: 
be the outermost ones from sth.: 
in between sth.: 
kind of like: 
...
4
bend bent: to push or press something so that it is no longer flat or straight:
expand on our model of atoms and electrons to dot: 
build up to 3D shapes: 
Spoiler alert: 
